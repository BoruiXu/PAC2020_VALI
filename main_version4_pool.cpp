...
inline double logDataVSPrior(const double* dat_0, const double* dat_1,const double* pri_0, const double* pri_1, const double* ctf, const double* sigRcp, const int num, const double disturb0)
{
    ...
    for(j=0;j<count;j++){
        results.emplace_back(
            pool.enqueue([j](const double* dat_0, const double* dat_1,const double* pri_0, const double* pri_1, const double* ctf, const double* sigRcp){
            ...
            },dat_0,dat_1,pri_0,pri_1,ctf,sigRcp
        ));
    }
